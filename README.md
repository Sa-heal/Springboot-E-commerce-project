...
6. Open http://localhost:8080/ in your browser!
   * If you ran the [`basedata.sql`](https://github.com/Sa-heal/E-commerce-springboot-website/blob/main/basedata.sql)script on the database, you can log in with the following credentials as admin; otherwise you'll have to manually create an admin user in the database:
     * Username: `admin`
     * Password: `123`
...
# Workflow
- ![image](https://github.com/Sa-heal/Springboot-E-commerce-project/blob/main/assets/workflow.png)
### Controller
...
## Preview
![image](https://github.com/Sa-heal/Springboot-E-commerce-project/blob/main/assets/preview1.png)
![image](https://github.com/Sa-heal/Springboot-E-commerce-project/blob/main/assets/preview2.png)
![image](https://github.com/Sa-heal/Springboot-E-commerce-project/blob/main/assets/preview3.png)
